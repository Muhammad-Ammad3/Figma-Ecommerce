...
function Cart() {
  ...
  <Link to={'/comparison'}>
    ...
    <div class="flex flex-col md:flex-row justify-center mb-5 gap-12">
        <h1 class="text-3xl font-normal">Description</h1>
        <h1 class="text-3xl font-normal text-gray-400">Additional Information</h1>
    </div>
    <div class="mb-5 text-gray-400 py-6">
