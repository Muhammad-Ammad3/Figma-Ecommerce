...
<div>
 ...
 <div className="flex justify-center items-center min-h-screen">
            <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 w-full ml-44 ">
                <Image 
                preview={false}
                    height={500}
                    width={1200} 
                    src="https://s3-alpha-sig.figma.com/img/56f7/6fe2/41417cd682c30a19eecaf20a549cee89?Expires=1730678400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Q7M-TZvzPElgVyYqrkIMQgBHS~9nMZ5VY4yBO0V8NwNB6swCSA7vmyKkP3EQJB2ZFdl2D5aTRrHwHUbRW6Rldb5h3gqQsRCrFNvEtrSD-KPb12ATU~emC3cdhVBPWBtT9r3ynD0SphlJZ5mRLJZV0xKfj7mSHIp-oCAwnCpZEN2MF-uOUfWTKdUzphSjbcmJavbDaikIVat1oqrY9REJhOVsoUX~y4Jd-HC-V5jb~xJW4veuIx0U5NJ44ET4LF2aH788bCCUFpbRzEUYMUBaZEYh3S2SW1EMv~6B2ccBo2oUtI0CMSOA1aqJeVEkr7d1EtP5q3A5AahISYm-Ef2Grg__"
                    alt="Card Image"
                ...
                <h1 className="text-xl font-semibold mb-2">Going all-in with millennial design</h1>
 ...
 <div className="flex justify-center items-center min-h-screen">
            <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 w-full ml-44 ">
                ...
                preview={false}
                    height={500}
                    width={1200} 
                    src="https://s3-alpha-sig.figma.com/img/d248/0301/96ed5dc3b3d01cf6cd369ef7aff2f296?Expires=1730678400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=m0rRV-2IGASsrwh1DjvpOJffZCJLCKJnghWAeLfPoITvymLcDE21UJOn-EG4HX6KEPZGZTRFcz~2ZV8svLQIdTAhFYuNThTnmK4xzxRbicty~XXQ4L7h1HGpdQGk2YeZ2tbpnKSIa4Uj58xWyj-9kuxVbE~Nr4lVPks6si1IMLStt59f4YLNWi6P67tiigJ3iEmiO~ZoBCN5jj7JX0TTHUcFDJPDJUlXtY19v6T5J17UAmf-~hwVOf7ZrmVVlRV~zmRptrfQbkAfrZ~w3a1iNvWrUW31zu2RsczoK9GSpHH13l~I8KbAD4YANofWlE-Qf~ctHgt7LLE5Tx~VJzABuA__"
                    alt="Card Image"
                    className="w-full h-48 object-cover rounded-lg mb-4"
                />
                <div className="flex items-center mb-2 gap-2">
                ...
                <h1 className="text-xl font-semibold mb-2">Exploring new ways of decorating</h1>
                <p className="text-gray-700 mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Mus <br />
                    mauris vitae ultricies leo integer malesuada nunc. In nulla posuere sollicitudin aliquam ultrices. Morbi blandit cursus risus <br />
                    at ultrices mi tempus imperdiet. Libero enim sed faucibus turpis in. Cursus mattis molestie a iaculis at erat. Nibh cras <br />
 ...
 <div className="flex justify-center items-center min-h-screen">
            <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 w-full ml-44 ">
                ...
                <h1 className="text-xl font-semibold mb-2">Handmade pieces that took time to make</h1>
                <p className="text-gray-700 mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Mus <br />
                    mauris vitae ultricies leo integer malesuada nunc. In nulla posuere sollicitudin aliquam ultrices. Morbi blandit cursus risus <br />
                    at ultrices mi tempus imperdiet. Libero enim sed faucibus turpis in. Cursus mattis molestie a iaculis at erat. Nibh cras <br />
